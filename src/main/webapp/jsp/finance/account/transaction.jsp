...
<head>
	...
	<title>Transaction Info Overview</title>
...
<body>
    <div class="well title"><a href="#">${bank} ${maskNo}</a>交易明细</div>
    <table id="tb_transaction" data-toolbar="#toolbar"></table>
    ...
    <div id="toolbar">
    	...
    	<div class="input-group" style="width: 260px; float: right" id="block_search">
    	    <input type="text" id="txt_search" name="tranUser" class="form-control col-sm-2" placeholder="交易用户">
	            ...
	            <div class="modal-body">  
	                <form id="formSearch" class="form-horizontal">
	                    <div class="form-group" style="margin-top:15px">
	                        <label class="control-label col-sm-3" for="txt_search_tranUser">交易用户</label>
	                        <div class="col-sm-8">
	                            <input type="text" class="form-control" id="txt_search_tranUser" name="tranUser">
	                        </div>	                                                
	                    </div>
	                    <div class="form-group" style="margin-top:15px">
 							<label class="control-label col-sm-3" for="txt_search_orderId">订单号</label>
	                        <div class="col-sm-8">
	                            <input type="text" class="form-control" id="txt_search_orderId" name="orderId">
	                        </div>
	                    </div> 
	                    <div class="form-group" style="margin-top:15px">
 							<label class="control-label col-sm-3" for="txt_search_purchaseId">供应商</label>
	                        <div class="col-sm-8">
	                            <input type="text" class="form-control" id="txt_search_purchaseId" name="purchaseId">
	                        </div>
	                    </div>   
	                    <div class="form-group" style="margin-top:15px">
    ...
    <script src="<%=basePath %>assets/js/finance/transaction_index.js"></script>
</body>
</html>