...
<body>
    <ul id="myTab" class="nav nav-tabs">
		...
		<li class="active">
			<a href="#storageDetail" data-toggle="tab">入库明细</a>
		</li>		
		<li>
			<a href="#storage" data-toggle="tab">库存</a>
		</li>
	</ul>
	
	<div id="myTabContent" class="tab-content">
		<div class="tab-pane fade " id="storage">
			<table id="tb_storage" data-toolbar="#tlb_storage"></table>
			<div id="tlb_storage">
			    <div class="input-group" style="width: 260px; float: right" id="block_search">
		    	    <input type="text" id="spdtNo" name="pdtNo" class="form-control col-sm-2" placeholder="货号">
		    	    <span class="input-group-addon" id="span_search_stat">
		...
		<div class="tab-pane fade in active" id="storageDetail">
			<table id="tb_storagedt" data-toolbar="#tlb_detail"></table>
		    ...
		    <div id="tlb_detail">
		    	...
		    	<div class="input-group" style="width: 260px; float: right" id="block_search">
		    	    <input type="text" id="txt_search" name="condition" class="form-control col-sm-2" placeholder="货号">
			            ...
			            <div class="modal-body">  
			                <form id="formSearch" class="form-horizontal">
			                    <div class="form-group" style="margin-top:15px">
			                        <label class="control-label col-sm-3" for="txt_search_pdtNo">货号</label>
			                        <div class="col-sm-8">
			                            <input type="text" class="form-control" id="txt_search_pdtNo" name="pdtNo">
			                        </div>	                                                
			                    </div>
    ...
    <script src="<%=basePath %>assets/js/finance/storage_index.js"></script>
</body>
</html>