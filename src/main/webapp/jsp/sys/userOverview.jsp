...
<head>
	...
	<title>User Info Overview</title>
...
<body>
    <div class="well title">系统用户列表</div>
    <table id="tb_user" data-toolbar="#toolbar" ></table>
    <div id="toolbar">
    ...
    <script src="<%=basePath %>assets/js/sys/user_index.js"></script>
