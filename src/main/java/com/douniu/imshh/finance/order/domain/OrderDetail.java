...
public class OrderDetail {
	...
	public OrderDetail(String orderId, String pdtNo, String pdtName, int quantity, float priceRMB, float priceDollar,
	...
	public String toString() {
		return "OrderDetail [id=" + id + ", orderId=" + orderId + ", pdtNo=" + pdtNo + ", pdtId=" + pdtId + ", pdtName="
				+ pdtName + ", quantity=" + quantity + ", priceRMB=" + priceRMB + ", priceDollar=" + priceDollar
				+ ", totlemnt=" + totlemnt + ", progress=" + progress + ", remark=" + remark + ", status=" + status
				+ "]";
	}
